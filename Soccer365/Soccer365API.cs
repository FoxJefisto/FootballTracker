...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        public CompetitionPlayersStatistics GetCompetitionPlayerStatisticsById(string competitionId, string season = "", string size = "25", string page = "0", 
            SortScope scope = SortScope.goals, SortOrder sortOrder = SortOrder.DESC)
        {
        ...
        public CompetitionPlayersStatistics GetCompetitionPlayerStatisticsByName(string name, string country, string season = "", string size = "25", 
            string page = "0", SortScope scope = SortScope.goals, SortOrder sortOrder = SortOrder.DESC)
        {
            string id = GetCompetitionIdByName(name, country);
